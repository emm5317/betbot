...
You are working on **betbot**, a quantitative sports betting trading system built in Go. This file defines the project context, conventions, and constraints for all Codex sessions.
...
When starting a Codex session on betbot:
