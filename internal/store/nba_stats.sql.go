...
const upsertNBATeamStats = `-- name: UpsertNBATeamStats :exec
...
type UpsertNBATeamStatsParams struct {
...
func (q *Queries) UpsertNBATeamStats(ctx context.Context, arg UpsertNBATeamStatsParams) error {
	_, err := q.db.Exec(ctx, upsertNBATeamStats,
		arg.Source,
		arg.ExternalID,
		arg.Season,
		arg.SeasonType,
