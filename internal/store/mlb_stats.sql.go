...
const upsertMLBPitcherStats = `-- name: UpsertMLBPitcherStats :exec
...
type UpsertMLBPitcherStatsParams struct {
...
func (q *Queries) UpsertMLBPitcherStats(ctx context.Context, arg UpsertMLBPitcherStatsParams) error {
	_, err := q.db.Exec(ctx, upsertMLBPitcherStats,
		arg.Source,
		arg.ExternalID,
		arg.Season,
		arg.SeasonType,
...
const upsertMLBTeamStats = `-- name: UpsertMLBTeamStats :exec
...
type UpsertMLBTeamStatsParams struct {
	Source      string      `json:"source"`
	ExternalID  string      `json:"external_id"`
	Season      int32       `json:"season"`
	SeasonType  string      `json:"season_type"`
...
func (q *Queries) UpsertMLBTeamStats(ctx context.Context, arg UpsertMLBTeamStatsParams) error {
	_, err := q.db.Exec(ctx, upsertMLBTeamStats,
		arg.Source,
		arg.ExternalID,
		arg.Season,
		arg.SeasonType,
